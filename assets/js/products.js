(function () {
  ...
  function supabaseImg(url, width, quality) {
  ...
  function buildGallery() {
    ...
    photos.forEach(function (src, i) {
      ...
      ti.src = supabaseImg(src, 120, 75); ti.alt = ''; ti.width = 52; ti.height = 52; ti.loading = 'lazy';
      t.appendChild(ti);
      (function (index) {
  ...
  function setPhoto(idx) {
    ...
    activePhoto = idx;
    galleryMain.src = supabaseImg(photos[idx], 1200, 80);
